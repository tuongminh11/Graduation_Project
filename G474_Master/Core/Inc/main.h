...
#define PP_SELECT_Pin GPIO_PIN_2
#define PP_SELECT_GPIO_Port GPIOC
#define CP_SELECT_Pin GPIO_PIN_3
...
#define QCA_RS_Pin GPIO_PIN_2
#define QCA_RS_GPIO_Port GPIOB
